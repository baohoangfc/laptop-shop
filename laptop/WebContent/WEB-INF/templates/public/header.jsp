		...
		<div class="header-top-inner">
			<div class="cnt-account">
				<ul class="list-unstyled">
					<li><a href="#"><i class="icon fa fa-user"></i>${objLogin.fullname }</a></li>
					<li><a href="#"><i class="icon fa fa-heart"></i>Wishlist</a></li>
					<li><a href="${pageContext.request.contextPath }/cart/"><i class="icon fa fa-shopping-cart"></i>My Cart</a></li>
	...
	<div class="dropdown dropdown-cart">
		<a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
			<div class="items-cart-inner">
				...
				<div class="basket-item-count"><span id="selected" class="count">${sessionScope.cart.size() }</span></div>
		...
		<ul class="dropdown-menu">
				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-1 action">
							<a href="${pageContext.request.contextPath }/cart"><i class="fa fa-trash"></i></a>
						</div>
					</div>
				</div><!-- /.cart-item -->
				<div class="clearfix"></div>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Sub Total :</span><span id="pricess" class='price'>${s }</span>
